package com.linkjf.spacex_launch.home.data
...
object TestFixtures {
    ...
    fun createMockLaunchDtos(): List<LaunchDto> = listOf(
        LaunchDto(
            id = "launch_1",
    ...
    fun createMockLaunchDtosWithNulls(): List<LaunchDto> = listOf(
        LaunchDto(
            id = "launch_null",
            name = "Test Launch",
            dateUtc = "2024-01-15T14:30:00.000Z",
    ...
    fun createMockLaunches(): List<Launch> = listOf(
        Launch(
            id = "launch_1",
            name = "Falcon 9 Test Flight",
            dateUtc = "2024-01-15T14:30:00.000Z",
    ...
    fun createSingleMockLaunch(): Launch = Launch(
        id = "launch_single",
    ...
    fun createLargeApiResponse(count: Int = 10): String {
        val launches = (1..count).map { index ->
            """
            {
                "id": "5eb87cd9ffd86e000604b3${index.toString().padStart(2, '0')}",
                "name": "Launch $index",
                "date_utc": "2024-0${index % 9 + 1}-${index.toString().padStart(2, '0')}T${index.toString().padStart(2, '0')}:00:00.000Z",
                "success": ${index % 2 == 0},
                "links": {
                    "patch": {
